...
whilecheck = 0
portcount = 0
port = ["/dev/ttyUSB","/dev/ttyAMA"]
portListCheck = 0
omxplayerMusic = 'omxplayer -o local /home/pi/Desktop/AED/'
while(os.system('ls /dev/ttyUSB'+list[portcount]) != 0):
    ...
    if(portcount >= 3):
        ...
        portcount = 0
        break
if(os.system('ls /dev/ttyUSB'+list[portcount]) == 0):
    whilecheck = 1
if(whilecheck == 0):
    omxplayMusic = 'omxplayer -o local /home/pi/Desktop/AED/'
    while(os.system('ls /dev/ttAMA'+list[portcount]) != 0):
        portcount = portcount + 1
        if(portcount >= 3):
            break
